...
The exact 26.3.27 build keeps the Java/Kotlin API surface expected by v2rayNG, but some wrapper calls are downgraded because Xray-core v1.260327.0 does not expose the newer helper APIs used by later AndroidLibXrayLite builds: Android process finder registration, aggregate outbound counter enumeration, and live browser dialer reload.
